  ...
  return (
    ...
    <div className="footer">
            <div className="footer-left">
                <div className="logos">
                    <svg className='logo' xmlns="http://www.w3.org/2000/svg" width="53" height="62" viewBox="0 0 33 32" fill="none">
            ...
            <div className="footer-right">
                ...
                <div className="useful-links" id='part'>
                    <h2>Partner</h2>
